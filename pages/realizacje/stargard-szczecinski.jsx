...
import Gallery from "/components/gallery/_gallery_stargard";
...
const Home = () => {
  ...
  return (
    <>
      <NextSeo
        title={`Damansdak Polska - ${t("stargardTitle")}`}
        description={`${t("stargardDescription")}`}
        // canonical="https://damansdak.pl/realizacje/stargard"
        languageAlternates={[
          {
            hrefLang: "x-default",
            href: "https://damansdak.pl/realizacje/stargard",
          },
          {
            hrefLang: "pl",
            href: "https://damansdak.pl/realizacje/stargard",
          ...
          {
            hrefLang: "de",
            href: "https://damansdak.pl/de/realizacje/stargard",
          },
          {
            hrefLang: "ru",
            href: "https://damansdak.pl/ru/realizacje/stargard",
          },
          {
            hrefLang: "en",
            href: "https://damansdak.pl/en/realizacje/stargard",
          },
        ]}
        openGraph={{
          type: "website",
          url: "https://damansdak.pl/realizacje/stargard",
          title: `Damansdak Polska – ${t("stargardTitle")}`,
          ...
          images: [
            {
              ...
              width: 800,
              height: 600,
              alt: `Damansdak Polska – ${t("stargardTitle")}`,
            },
            {
              url: "https://damansdak.mo.cloudinary.net/hero.webp",
              width: 900,
          ...
          site_name: `Damansdak Polska – ${t("stargardTitle")}`,
        }}
        twitter={{
          handle: "@BDamans",
          site: "@bdamans",
      ...
      <section className="lg:pt-20">
        <div className="relative flex items-center overflow-hidden text-center bg-cover py-36">
          <img
            ...
            src="/realizacje/stargard/stargard_damansdak.jpg"
            alt="Realizacja w Stargardzie Szczecińskim"
          />
        ...
        <div className="mx-auto">
          <div className="px-8 mx-auto lg:w-3/5 sm:px-0 sm:w-4/5">
            <p className="mb-6 text-3xl lg:text-left lg:text-5xl font-heading">
              <CountUp start={80000} end={84000} duration={1.75} delay={0}>
                {({ countUpRef, start }) => (
      ...
      <img
        ...
        src="/realizacje/stargard/stargard_damansdak.jpg"
        alt="Damansdak w Stargardzie Szczecińskim"
        layout="responsive"
        height={1080}
        width={1920}
      />
