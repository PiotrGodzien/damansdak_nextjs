    ...
    <>
      ...
      <section className="lg:pt-20">
        <div className="relative flex items-center overflow-hidden text-center bg-cover py-36">
          <img className="absolute object-cover w-full h-full bg-center" src="https://damansdak.s3.eu-central-1.amazonaws.com/litwa/litwa4.jpg" alt="" />
          ...
          <div className="relative max-w-4xl px-4 mx-auto">
            ...
            <h2 className="text-3xl text-center text-white lg:text-5xl lg:text-left font-heading">Wystartowaliśmy z nową realizacją na terenie Litwy</h2>
          </div>
        </div>
