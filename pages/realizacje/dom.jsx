...
import Gallery from "/components/gallery/_gallery_dom";
...
const Home = () => {
  ...
  return (
    <>
      <NextSeo
        title={`Damansdak Polska - ${t("domTitle")}`}
        description={`${t("domDescription")}`}
        canonical="https://damansdak.pl/realizacje/dom"
        languageAlternates={[
          {
            hrefLang: "pl",
            href: "https://damansdak.pl/realizacje/dom",
          },
          {
            hrefLang: "de",
            href: "https://damansdak.pl/de/realizacje/dom",
          },
          {
            hrefLang: "ru",
            href: "https://damansdak.pl/ru/realizacje/dom",
          },
          {
            hrefLang: "en",
            href: "https://damansdak.pl/en/realizacje/dom",
          },
        ]}
        openGraph={{
          type: "website",
          url: "https://damansdak.pl/realizacje/dom",
          title: `Damansdak Polska – ${t("domName")}`,
          ...
          images: [
            {
              ...
              width: 800,
              height: 600,
              alt: `Damansdak Polska – ${t("domName")}`,
            },
            {
              url: "https://damansdak.mo.cloudinary.net/hero.webp",
              width: 900,
          ...
          site_name: `Damansdak Polska – ${t("domName")}`,
        }}
        twitter={{
          handle: "@BDamans",
          site: "@bdamans",
        ...
        <div className="mx-auto">
          <div className="px-8 mx-auto lg:w-3/5 sm:px-0 sm:w-4/5">
            <p className="mb-6 text-3xl lg:text-left lg:text-5xl font-heading">
              <CountUp start={300} end={350} duration={1.75} delay={0}>
                {({ countUpRef, start }) => (
