...
const Home = () => {
  ...
  return (
    <>
      <NextSeo
        title={`Damansdak Polska - ${t("zoryTitle")}`}
        description={`${t("zoryDescription")}`}
        canonical="https://damansdak.pl/realizacje/zory"
        languageAlternates={[
          {
            hrefLang: "pl",
            href: "https://damansdak.pl/realizacje/zory",
          },
          {
            hrefLang: "de",
            href: "https://damansdak.pl/de/realizacje/zory",
          },
          {
            hrefLang: "ru",
            href: "https://damansdak.pl/ru/realizacje/zory",
          },
          {
            hrefLang: "en",
            href: "https://damansdak.pl/en/realizacje/zory",
          },
        ]}
        openGraph={{
          type: "website",
          url: "https://damansdak.pl/realizacje/zory",
          title: `Damansdak Polska – ${t("zoryTitle")}`,
          ...
          images: [
            {
              ...
              width: 800,
              height: 600,
              alt: `Damansdak Polska – ${t("zoryTitle")}`,
            },
            {
              url: "https://damansdak.mo.cloudinary.net/hero.webp",
              width: 900,
          ...
          site_name: `Damansdak Polska – ${t("zoryTitle")}`,
        }}
        twitter={{
          handle: "@BDamans",
          site: "@bdamans",
