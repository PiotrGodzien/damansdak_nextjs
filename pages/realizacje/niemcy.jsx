...
import Gallery from "/components/gallery/_gallery_niemcy";
...
const Home = () => {
  ...
  return (
    <>
      <NextSeo
        title={`Damansdak Polska - ${t("niemcyTitle")}`}
        description={`${t("niemcyDescription")}`}
        canonical="https://damansdak.pl/realizacje/niemcy"
        languageAlternates={[
          {
            hrefLang: "pl",
            href: "https://damansdak.pl/realizacje/niemcy",
          },
          {
            hrefLang: "de",
            href: "https://damansdak.pl/de/realizacje/niemcy",
          },
          {
            hrefLang: "ru",
            href: "https://damansdak.pl/ru/realizacje/niemcy",
          },
          {
            hrefLang: "en",
            href: "https://damansdak.pl/en/realizacje/niemcy",
          },
        ]}
        openGraph={{
          type: "website",
          url: "https://damansdak.pl/realizacje/niemcy",
          title: `Damansdak Polska – ${t("niemcyTitle")}`,
          ...
          images: [
            {
              ...
              width: 800,
              height: 600,
              alt: `Damansdak Polska – ${t("niemcyTitle")}`,
            },
            {
              url: "https://damansdak.mo.cloudinary.net/hero.webp",
              width: 900,
          ...
          site_name: `Damansdak Polska – ${t("niemcyTitle")}`,
        }}
        twitter={{
          handle: "@BDamans",
          site: "@bdamans",
