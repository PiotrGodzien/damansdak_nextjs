...
import Gallery from '/components/gallery/_gallery_blonie';
      ...
      <section className="lg:pt-20">
        <div className="relative flex items-center py-36 text-center bg-cover overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4">
            ...
            <h2 className="text-3xl font-bold lg:text-5xl text-center lg:text-left text-white font-heading">Kajima Poland Sp. z o.o. dla P3 Logistigs w Błoniu k. W-wy</h2>
          </div>
        </div>
        ...
        <LazyShow>
          <div className="mx-auto">
            <div className="lg:w-3/5 sm:px-0 sm:w-4/5 px-8 mx-auto">
              ...
              <p className="mb-6 font-serif text-lg font-light text-gray-500">Dwie hale o łącznej powierzchni ok. 34 000 m2.</p>
