      ...
      <section className="lg:pt-20">
        ...
        <div class="flex flex-wrap mx-auto items-center w-full lg:w-7/12 px-4">
          <div class="w-full lg:w-1/2 px-3">
            <img class="mb-6 w-full h-64 object-cover rounded-lg" src="https://damansdak.s3.eu-central-1.amazonaws.com/pracownicy/pracownicy8.jpg" alt="" />
            <img class="w-full h-64 object-cover rounded-lg" src="https://damansdak.s3.eu-central-1.amazonaws.com/pracownicy/pracownicy5.jpg" alt="" />
          </div>
          <div class="w-full lg:w-1/2 px-3">
            <img class="w-full h-64 object-cover rounded-lg" src="https://damansdak.s3.eu-central-1.amazonaws.com/pracownicy/pracownicy1.jpg" alt="" />
          </div>
        </div>
        <div className="px-8 py-8 mx-auto lg:w-3/5 sm:px-0 sm:w-4/5">
