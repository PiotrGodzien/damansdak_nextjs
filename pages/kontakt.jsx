        ...
        <div className="py-4 mb-6 bg-pattern"></div>
          ...
          <div className="px-8 py-8 mx-auto lg:my-16 lg:w-3/5 sm:px-0 sm:w-4/5">
            ...
            <p className="mt-6 font-serif text-lg font-light text-gray-500 lg:w-10/12">
              Jeżeli masz pytania dotyczące naszej oferty lub chcesz zapytać o
          ...
          <div className="flex flex-col px-8 mx-auto lg:my-8 lg:w-3/5 sm:px-0 sm:w-4/5">
            ...
            <div className="mt-8 lg:mt-16">
              ...
              <div className="flex mt-2 font-serif text-lg font-light text-gray-500">
                ...
                <p className="">
                  <a href="mailto:realizacja@damansdak.pl">realizacja@damansdak.pl</a>
                </p>
              </div>
              <div className="flex mt-2 font-serif text-lg font-light text-gray-500">
                <svg
            ...
            <div className="mt-8 lg:mt-16">
              ...
              <div className="flex mt-2 font-serif text-lg font-light text-gray-500">
                ...
                <p className="">
                  <a href="mailto:rekrutacja@damansdak.pl">rekrutacja@damansdak.pl</a>
                </p>
              </div>
              <div className="flex mt-2 font-serif text-lg font-light text-gray-500">
                <svg
            ...
            <div className="">
              <div className="">
                ...
                <p className="mt-4 font-serif text-lg font-light text-gray-500">
                  ul. Mierosławskiego 14, 37-700 Przemyśl
                </p>
