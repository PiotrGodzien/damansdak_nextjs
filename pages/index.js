  ...
  return (
    <div className="">
      ...
      <main className="text-secondary">
        <nav className="sticky top-0 z-50 py-6 text-xl text-white bg-secondary">
          <div className="flex items-center px-8 mx-auto bg-transparent max-w-7xl">
            ...
            <div className="hidden ml-auto lg:block">
              <div className="py-3 border border-white px-9">Kontakt</div>
            </div>
        ...
        <div className="">
          <div className="flex flex-col-reverse items-center justify-between mx-auto md:flex-row">
            <div className="items-center px-8 mx-auto mt-6 space-y-7 md:space-y-2 lg:space-y-10">
              ...
              <p className="text-gray-500 lg:text-xl">Dachy płaskie w technologii membran PVC i TPO.</p>
              <button className="flex items-center px-10 py-4 text-white bg-primary justify-self-end">
                <p className="lg:text-xl">Zadzwoń</p>
              </button>
            </div>
            <div className="md:w-7/12 bg-gray-50">
              <img src="http://verdepro.pl/dach3.jpg" alt="" className="" />
